...
declare global {
  interface Window {
    electronAPI: {
      ...
      signPdf: (opts: { fileData?: Uint8Array; filePath?: string; originalName?: string; slotId: string; certDerBase64: string; chainB64: string[]; signatureBox?: { page: number, x: number, y: number, w: number, h: number } | null }) => Promise<{ success: boolean; destPath?: string; error?: string }>;
